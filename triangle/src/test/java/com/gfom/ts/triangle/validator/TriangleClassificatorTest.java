...
public class TriangleClassificatorTest {
	...
	public void testEquilateral() {
		...
		assertEquals(TriangleType.equilateral, TriangleClassificator.classifyTriangle(t));
	}

	@Test
	public void testIsoceles() {
		Triangle t = new Triangle(3, 3, 1);
		assertEquals(TriangleType.isosceles, TriangleClassificator.classifyTriangle(t));
	}

	@Test
	public void testScalene() {
		Triangle t1 = new Triangle(3, 2, 1);
		assertEquals(TriangleType.scalene, TriangleClassificator.classifyTriangle(t1));

		Triangle t2 = new Triangle(1, 3, 2);
		assertEquals(TriangleType.scalene, TriangleClassificator.classifyTriangle(t2));

		Triangle t3 = new Triangle(2, 1, 3);
		assertEquals(TriangleType.scalene, TriangleClassificator.classifyTriangle(t3));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testZeroSizeTriangle() {
		Triangle t = new Triangle(0, 2, 1);
		TriangleClassificator.classifyTriangle(t);
	}
	...
	public void testSimetricTriangles() {
		...
		TriangleType type1 = TriangleClassificator.classifyTriangle(t1);
		TriangleType type2 = TriangleClassificator.classifyTriangle(t2);
